...
#Database 
DB_URI = "mongodb+srv://Master2:Ak997110@cluster0.iycaq.mongodb.net/?retryWrites=true&w=majority"
DB_NAME = os.environ.get("DATABASE_NAME", "Master")

SHORTLINK_URL = os.environ.get("SHORTLINK_URL", "http://udlinks.com")
SHORTLINK_API = os.environ.get("SHORTLINK_API", "cace96143121b04c7d6d31da0b0a37d5aaefc5c2")
VERIFY_EXPIRE = int(os.environ.get('VERIFY_EXPIRE', 86400))  # Add time in seconds
IS_VERIFY = os.environ.get("IS_VERIFY", "True")
TUT_VID = os.environ.get("TUT_VID", "https://t.me/hwtoopen")
